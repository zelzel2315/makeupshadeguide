...
makeups = Makeup.create([
  ...
  {brand: "Make Up For Ever", product: "Mat Velvet + Matifying Foundation", shade: "75", true_shade_id: ts[26].id, image:"MakeupForever75.jpg"},
  {brand: "MAC", product: "Matchmaster SPF 15 Foundation", shade: "8", true_shade_id: ts[26].id, image:"MacMatchmaster8.jpg"},
  {brand: "e.l.f.", product: "Studio Flawless Finish Foundation", shade: "Coco #83116", true_shade_id: ts[26].id, image:"ElfStudioCoco.jpg"}, 
  {brand: "L’Oreal", product: "Magic Skin Beautifier B.B. Cream", shade: "814 Medium", true_shade_id: ts[19].id, image:"LorealMagicskin814.jpg"},
  {brand: "L'Oreal", product: "True Match Lumi Healthy Foundation", shade: "Buff Beige", true_shade_id: ts[19].id, image:"LorealTruematchBeige.jpg"},
  {brand: "Kat Von D", product: "Lock-it Tattoo Foundation", shade: "Medium 54", true_shade_id: ts[19].id, image:"KatVonDTattoo54.jpg"},
  {brand: "Revlon", product: "ColorStay Makeup For Combo/Oily Skin", shade: "350 Rich Tan", true_shade_id: ts[19].id, image:"RevlonColorstayRichtan.jpg"},
  {brand: "Urban Decay", product: "Naked Skin Foundation", shade: "6.0", true_shade_id: ts[19].id, image:"UrbanDecayNaked6.jpg"},
  {brand: "Chanel", product: "Vitalumiere Aqua Ultra Light Skin Perfecting Make Up SFP 15", shade: "B30 Sable", true_shade_id: ts[13].id, image:""},
  {brand: "Neutrogena", product: "Healthy Skin Liquid Makeup Broad Spectrum SPF 20", shade: "Natural Beige", true_shade_id: ts[13].id, image:""},
  {brand: "Estee Lauder", product: "Double Wear Stay-in-Place Makeup", shade: "Sand 1W2", true_shade_id: ts[13].id, image:""},
  {brand: "Revlon", product: "Colorstay Combination/Oily SPF 6", shade: "280 Golden Beige", true_shade_id: ts[13].id, image:""},
  {brand: "Tarte", product: "Powderful Amazonian Clay Pressed Mineral Powder", shade: "Medium 08", true_shade_id: ts[13].id, image:""}, 
  {brand: "Revlon", product: "Nearly Naked", shade: "260 Caramel", true_shade_id: ts[23].id, image:""},
  {brand: "Liz Earle", product: "Signature Foundation", shade: "Caramel 07", true_shade_id: ts[23].id, image:""},
  {brand: "MAC", product: "Face and Body Foundation", shade: "C7", true_shade_id: ts[23].id, image:""},
  {brand: "NARS", product: "Sheer Matte", shade: "New Orleans", true_shade_id: ts[22].id, image:""},
  {brand: "MAC", product: "Studio Fix Fluid Foundation", shade: "NW45", true_shade_id: ts[22].id, image:""},
  {brand: "e.l.f.", product: "Tinted Moisturizer", shade: "Espresso", true_shade_id: ts[22].id, image:""},
  {brand: "Iman", product: "Second to None Luminous Foundation", shade: "Earth 2", true_shade_id: ts[22].id, image:""},
  {brand: "CoverGirl", product: "Queen Collection 3 in 1 Foundation", shade: "Q840 Almond Glow", true_shade_id: ts[25].id, image:""},
  {brand: "Revlon", product: "ColorStay Makeup For Combo/Oily Skin", shade: "440 Mahogany", true_shade_id: ts[25].id, image:""},
  {brand: "MAC", product: "Studio Sculpt Foundation", shade: "NW20", true_shade_id: ts[6].id, image:""},
  {brand: "Rimmel", product: "Wake Me Up Foundation", shade: "True Ivory", true_shade_id: ts[6].id, image:""},
  ...
  {brand: "Make Up For Ever", product: "HD Invisible Cover Foundation", shade: "140", true_shade_id: ts[14].id, image:""},
  {brand: "Make Up For Ever", product: "Mat Velvet + Matifying Foundation", shade: "40", true_shade_id: ts[14].id, image:""},
  {brand: "Urban Decay", product: "Naked Skin Foundation", shade: "4.0", true_shade_id: ts[14].id, image:""}
  ])
